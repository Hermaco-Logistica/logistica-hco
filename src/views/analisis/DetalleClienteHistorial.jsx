              ...
              <div className="min-w-0">
                ...
                <div className="flex flex-wrap items-center gap-x-4 gap-y-2">
                  <span className="text-xs font-medium text-slate-500 flex items-center gap-1.5">
                    ...
                    <strong className="text-slate-700">{infoCliente.totalRfqs}</strong> {infoCliente.totalRfqs === 1 ? 'RFQ' : 'RFQs'}
                  </span>
                </div>
              </div>
            </div>
          ...
          {vendedorFilter && (
            <div className="inline-flex items-center justify-between sm:justify-start gap-1.5 px-2.5 py-1.5 bg-white border border-slate-200/70 rounded-lg text-xs shadow-sm w-full sm:w-auto">
              <div className="flex items-center gap-1.5 overflow-hidden">
                ...
                <span className="font-semibold text-slate-700 truncate max-w-[120px]">{vendedorFilter}</span>
              </div>
              <button 
                type="button" 
